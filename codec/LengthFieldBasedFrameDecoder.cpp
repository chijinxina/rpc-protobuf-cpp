...
bool LengthFieldBasedFrameDecoder::decode(Context* ctx,
  ...
  if (buf.chainLength() < lengthFieldEndOffset_) {
    //std::cout<<"[error] -- "<<"buf.chainLength() < lengthFieldEndOffset_"<<std::endl;
    return false;
  }
  ...
  if (frameLength < lengthFieldEndOffset_) {
    ...
    std::cout<<"[error] -- "<<"frameLength < lengthFieldEndOffset_"<<std::endl;
    return false;
  }
  ...
  if (frameLength > maxFrameLength_) {
    ...
    std::cout<<"[error] -- "<<"frameLength > maxFrameLength_"<<std::endl;
    return false;
  }

  if (buf.chainLength() < frameLength) {

    std::cout<<"[error] -- "<<"buf.chainLength() < frameLength"<<std::endl;
  ...
  if (initialBytesToStrip_ > frameLength) {
    ...
    std::cout<<"[error] -- "<<"initialBytesToStrip_ > frameLength"<<std::endl;
    return false;
  }
